 ...
 */
class PlayerFlagTriggerEvent(val player: Player, val target: Player, val playerRegion: RegionManager.RegionData?, val targetRegion: RegionManager.RegionData?, val flagType: FlagType): Event(), Cancellable {
    companion object {
